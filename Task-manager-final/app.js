...
var app=express();
/*Sanitizer is used during update and create (both times we are saving data to the database) in order to discard
any script tag input by the user*/
...
//     body:"hello i am a beautiful dog"
// })
...
app.post("/tasks",function(req,res){
    //sanitizing whatever input is given by the user before storing it in the database
    //removes the script tag input by the user
    req.body.task.body=req.sanitize(req.body.task.body);
    //capturing all inputs from the form
        // var title= req.body.blog.title;
        // var image= req.body.blog.image;
        // var body= req.body.blog.body;
        // var newblog={title:title, image:image, body:body};
    //creating the newblog in the database and redirecting to "/blogs"
...
// <%= : simply takes the value and displays it as text
// <%- : runs the code
// <%  : when doing some logic and not taking any value
